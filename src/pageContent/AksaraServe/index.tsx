  ...
  return (
    <>
      <div className={S.AksaraSection}>
        <div
          className={`min-h-screen w-4/5 flex flex-col justify-start items-center border-black border-b-2`}
        >
          <div
            className={`border-b-2 border-black text-1xl lg-min:text-3xl font-extrabold`}
          >
            [ak.sa.ra]
          </div>
          <div
            className={`mt-16 border-black text-3xl lg-min:text-5xl font-extrabold`}
          >
            {title}
          </div>
          ...
          ></Image>
          <div
            className={`mt-8 mb-8 text-1xl lg-min:text-1xl text-justify whitespace-pre-line`}
          >
            {text}
          </div>
          <div
            className={`mt-8 mb-8 border-black text-1xl lg-min:text-2xl font-bold`}
          >
            share this:
          </div>
          ...
          <div
            className={`mt-8 mb-8 text-1xl lg-min:text-1xl text-justify justify-center flex`}
          >
            ...
            <div className={`ml-4 mr-4 text-red-500`}>
              <Image
        ...
        <div
          className={`mt-8 pb-8 w-screen bg-aksara-comment flex flex-col items-center`}
        >
          <ReplyBox />
        </div>
