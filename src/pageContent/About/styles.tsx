export const StorySection = `grid grid-cols-12 grid-rows-6 gap-6 h-screen`;
export const StoryImage = `mt-10 h-full w-full bg-about-ourstory bg-cover bg-center bg-no-repeat shadow-lg`;
export const StoryRedStrip = `ml-20 h-full w-full bg-pinus-red`;
